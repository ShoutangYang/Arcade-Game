...
var Engine = (function(global) {
    ...
    ctx.strokeText('Arcade Game',canvas.width/3,25);
    ...
    function main() {
        ...
        /*
        * */
        document.getElementById('timed').innerHTML='Timed:'+Math.floor((lastTime-startTimed)/1000).toString()+'s';
    ...
    /*这个函数是检测是否已经碰撞，如果碰撞将重新开始。
    *判断player 的横纵坐标的位置，同allEnemies中的角色位置是否在允许的范围之内。
    *
     */
